...
const RoomCard = ({ id, title, location, occupancy, living, profession, image, price }) => {
    ...
    const handleEditUser = () => {
        router.push(`/pages/Skeleton?id=${id}`);
    };
            ...
            <div className={styles.contentRc}>
                ...
                <div className={styles.roomInfo}>
                    ...
                    <div className={styles.roomPB}>
                        <button className={styles.roomButton} onClick={handleEditUser}>I'm Interested</button> {/* Use the handleEditUser function directly */}
                    </div>
                </div>
            </div>
        </div>
